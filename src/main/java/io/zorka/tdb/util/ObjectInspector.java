...
public class ObjectInspector {
    ...
    private static Logger log = LoggerFactory.getLogger(ObjectInspector.class);
    ...
    public static Object getAttr(Object obj, Object key) {
        ...
        if (obj instanceof Map<?, ?>) {
            ...
            Integer idx = (Integer) ZicoUtil.coerce(key, Integer.class);
        ...
        } else if (ZicoUtil.instanceOf(obj.getClass(), "javax.management.j2ee.statistics.Stats")) {
            try {
    ...
    public static List<?> list(Object obj) {
        ...
        if (obj instanceof Map) {
            ...
            for (Object k : ((TabularData) obj).keySet()) {
                lst.add(ZicoUtil.join(",", (Collection<?>) k));
            }
        } else if (ZicoUtil.instanceOf(obj.getClass(), "javax.management.j2ee.statistics.Stats")) {
            try {
    ...
    public static final Pattern reDollarSign = Pattern.compile("$", Pattern.LITERAL);
    public static final String reDollarReplacement = Matcher.quoteReplacement("\\$");
    ...
    public static boolean setField(Object obj, String fieldName, Object value) {
        if (obj != null) {
            ...
            try {
                field.set(obj, t.isInstance(value) ? value : ZicoUtil.coerce(value, t));
            } catch (IllegalAccessException e) {
                e.printStackTrace();
            }
